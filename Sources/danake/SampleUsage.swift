...
*/
    static func testDemonstrateUpdateErrors () throws -> Bool {
        ...
        // Demonstrate that the previous changes were lost due to the reported unrecoverable error
            ...
            ParallelTest.AssertTrue (label: "testDemonstrateUpdateErrors.3.Linux.11", testResult: &overallTestResult, employeeJson.contains("\"cacheName\":\"company\""))
        ...
        // Demonstrate that the data was updated in persistent media
            ...
            ParallelTest.AssertTrue (label: "testDemonstrateUpdateErrors.8.Linux.11", testResult: &overallTestResult, employeeJson.contains("\"cacheName\":\"company\""))
